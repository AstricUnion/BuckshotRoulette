...
tableholos = {
    ...
    hologram.createPart(
        ...
        Holo(SubHolo(Vector(-61.64,0,36),Angle(0),"models/hunter/blocks/cube05x05x05.mdl",Vector(0.7,3.11,0.05),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")),
        Holo(SubHolo(Vector(0,61.64,36),Angle(0),"models/hunter/blocks/cube05x05x05.mdl",Vector(3.11,0.7,0.05),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")),
        Holo(SubHolo(Vector(0,-61.64,36),Angle(0),"models/hunter/blocks/cube05x05x05.mdl",Vector(3.11,0.7,0.05),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")), 
        Holo(SubHolo(Vector(61.64,45.15,36),Angle(90,0,0),"models/hunter/triangles/05x05x05.mdl",Vector(0.05,0.7,0.7),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")),
        Holo(SubHolo(Vector(61.64,-45.15,36),Angle(-90,180,0),"models/hunter/triangles/05x05x05.mdl",Vector(0.05,0.7,0.7),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")),
        Holo(SubHolo(Vector(-61.64,45.15,36),Angle(-90,0,0),"models/hunter/triangles/05x05x05.mdl",Vector(0.05,0.7,0.7),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")),
        Holo(SubHolo(Vector(-61.64,-45.15,36),Angle(90,180,0),"models/hunter/triangles/05x05x05.mdl",Vector(0.05,0.7,0.7),false,Color(150,200,150),"models/props_pipes/GutterMetal01a")),
